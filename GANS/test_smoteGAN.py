...
if True:
    for epoch in range(n_epochs):
        ...
        if epoch % 10 == 0:
            ...
            save_path = f"models/smote_gan_model_temp.pt"
            torch.save({
...
if save:
    ...
    save_path = f"models/smote_gan_model_1_{timestamp}.pt"
    torch.save({
        "generator_state_dict": generator.state_dict(),
        "discriminator_state_dict": discriminator.state_dict(),
        "g_losses": g_losses,
...
if load:
    load_path = "../models/decent_classgan_50.pt" # Path to load your model
    # load_path = "models/class_gan_model_m21_1003.pt"  # Sample model
...
test_smote_samples(generator, discriminator, dataset, sampleloader, batch_size=100000)
